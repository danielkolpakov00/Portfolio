...
const PlinkoDescription = () => (
  <section className="space-y-12 w-full">
    ...
    <h3 className="text-xl text-white md:text-2xl lg:text-3xl font-semibold pb-3 border-b border-gray-200 w-full">How I Built It</h3>
    
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-blue2/40 backdrop-blur-lg rounded-xl shadow-lg p-8">
        <h4 className="text-xl font-medium mb-4 text-white">Physics Engine</h4>
        <p className="text-lg leading-relaxed mb-4 text-white">Matter.js does the heavy lifting here. I had to experiment a ton with different physics properties to get that "just right" feeling:</p>
      ...
      <div className="bg-blue2/40 backdrop-blur-lg rounded-xl shadow-lg p-8">
        <h4 className="text-xl font-medium mb-4 text-white">Multiplier System</h4>
        <p className="text-lg leading-relaxed mb-4 text-white">Each landing zone has different point values with custom animations:</p>
        <ul className="list-disc pl-8 space-y-2 text-lg text-white">
    ...
    <div className="bg-blue2/40 backdrop-blur-lg rounded-xl shadow-lg p-8">
      <h4 className="text-xl font-medium mb-4 text-white">How it's Balanced</h4>
      <p className="text-lg leading-relaxed mb-4 text-white">As an attempt to balance the game as much as possible, I added a force that drags the balls inwards in order to balance the game a little bit. 
