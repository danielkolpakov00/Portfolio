...
const MailDescription = () => {
    ...
    return (
        <section className="space-y-6 w-full overflow-x-hidden">
            <h3 className="text-xl text-white md:text-2xl lg:text-2xl font-semibold pb-2 border-b border-gray-200 w-full">
                A neat little back-end API for sending emails.
            </h3>
            
            <p className="text-base md:text-lg lg:text-xl leading-relaxed max-w-full text-white">
            ...
            <h3 className="text-xl text-white md:text-2xl lg:text-2xl font-semibold pb-2 border-b border-gray-200 w-full">What Makes This Cool</h3>
            ...
            <h3 className="text-xl text-white md:text-2xl lg:text-2xl font-semibold pb-2 border-b border-gray-200 w-full">How It Works</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="bg-blue2/40 backdrop-blur-sm rounded-lg shadow p-4 md:p-6">
                    <h4 className="text-lg font-medium mb-3 text-white">Setting Up the Server</h4>
                    <p className="text-base leading-relaxed mb-3 text-white">The server is built using Node.js and Express. Here's a quick overview:</p>
                ...
                <div className="bg-blue2/40 backdrop-blur-sm rounded-lg shadow p-4 md:p-6">
                    <h4 className="text-lg font-medium mb-3 text-white">MongoDB</h4>
                    <p className="text-base leading-relaxed mb-3 text-white">The API uses MongoDB to store emails.</p>
                    <ul className="list-disc pl-5 space-y-1 text-base text-white">
            ...
            <p className="text-white pl-5 py-2 text-sm">Here's an example of what a record would look like in MongoDB:</p>
