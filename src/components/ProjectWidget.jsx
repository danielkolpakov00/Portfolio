...
const ProjectWidget = ({
  ...
  return (
    <div className="bg-whit/30 opacity-70 rounded-xl shadow-lg hover:shadow-[0_8px_12px_-3px_rgba(27,105,250,0.3)] transition-all duration-300 overflow-hidden shine-effect backdrop-blur-md relative flex flex-col min-h-[400px] h-auto sm:h-[500px]">
      <div className="h-[200px] sm:h-[250px] relative overflow-hidden bg-transparent backdrop-blur-sm flex-shrink-0">
        {Visual && <Visual />}
      </div>
      ...
      <div className="p-4 sm:p-6 border-t border-offwhite border-dashed border-opacity-50 backdrop-blur-sm flex flex-col flex-grow">
        <h3 className="text-2xl sm:text-3xl font-georama leading-tight mb-2 sm:mb-3 text-blue2 line-clamp-2">
          {title}
        </h3>
