          ...
          {section.boxes.map((box, idx) => (
            ...
            >
              <TiltedCard
                ...
                imageSrc={
                  (() => {
                    // Component mapping object for better readability and maintenance
                    const componentMap = {
                      "A bit about me": (
                        <VisibilityWrapper>
                          <LetterGlitch
                    ...
                    // Return the appropriate component or null if not found
                    return componentMap[box.heading] || null;
                  })()
                }
              />
            </motion.div>
